...
tracker:
  kind: linear
  project_slug: "trading-journal-9d4d0298c64a"
  required_labels: []
  active_states:
    - Todo
    - In Progress
...
agent:
  ...
  max_turns: 20
codex:
  command: codex app-server --config shell_environment_policy.inherit=all --config 'model="gpt-5.5"' --config model_reasoning_effort=high proxy
